...
![](../images/deploy/mycat/1573485852837.png)

最新下载地址: http://dl.mycat.io/

![](../images/deploy/mycat/1573485998327.png)
...
![](../images/deploy/mycat/1573536143760.png)
...
![](../images/deploy/mycat/1573556739880.png)
...
![](../images/deploy/mycat/1575724614686.png)
...
![](../images/deploy/mycat/1573916419746.png)


2). 通过sqlyog连接

![](../images/deploy/mycat/1573832298131.png)
...
![](../images/deploy/mycat/1574954845578.png)
...
![](../images/deploy/mycat/1574955059453.png)

3). rule

该属性用于指定逻辑表的分片规则的名字, 规则的名字是在rule.xml文件中定义的, 必须与tableRule标签中name属性对应。

![](../images/deploy/mycat/1574955534319.png)
...
![](../images/deploy/mycat/image-20200110193319982.png)
...
![](../images/deploy/mycat/image-20200112180630348.png)

最大值：

![](../images/deploy/mycat/image-20200112180643493.png)
...
![](../images/deploy/mycat/1577267028771.png)
...
![](../images/deploy/mycat/image-20200112234530612.png)
...
![](../images/deploy/mycat/1577358192118.png)
...
![](../images/deploy/mycat/1577370960657.png)

##### 5.1.3.2 配置

![](../images/deploy/mycat/1577372353498.png)

![](../images/deploy/mycat/1577372371549.png)
...
![](../images/deploy/mycat/1577373437531.png)
...
![](../images/deploy/mycat/1577373861622.png)
...
![](../images/deploy/mycat/1577374030291.png)
...
![](../images/deploy/mycat/1577374126073.png)
...
![](../images/deploy/mycat/1577374634946.png)


2). MySQL监控指标

![](../images/deploy/mycat/1577374588708.png)
...
![](../images/deploy/mycat/1577374982024.png)

2). SQL表分析

![](../images/deploy/mycat/1577375016852.png)

3). SQL监控

![](../images/deploy/mycat/1577375043787.png)



4). 高频SQL

![](../images/deploy/mycat/1577375072881.png)

5). 慢SQL统计

![](../images/deploy/mycat/1577375100383.png)

6). SQL解析

![](../images/deploy/mycat/1577375162928.png)
...
![](../images/deploy/mycat/image-20200103102209631.png)
...
![](../images/deploy/mycat/image-20200103144903105.png)
...
![](../images/deploy/mycat/image-20200103103029311.png)

在该数据库中，查询user表中的数据：

![](../images/deploy/mycat/image-20200103103049675.png)
...
![](../images/deploy/mycat/image-20200103140249789.png)
...
![](../images/deploy/mycat/image-20200103170452653.png)
...
![](../images/deploy/mycat/image-20200104090901765.png)


查询Master2的状态 :

![](../images/deploy/mycat/image-20200104090922386.png)
...
![](../images/deploy/mycat/image-20200104091917814.png)


![](../images/deploy/mycat/image-20200104091948213.png)
...
![](../images/deploy/mycat/image-20200104092654432.png)

![](../images/deploy/mycat/image-20200104092741892.png)
...
![](../images/deploy/mycat/image-20200104095232047.png)



在Master1上创建表 :

![](../images/deploy/mycat/image-20200104095521070.png)
...
![](../images/deploy/mycat/image-20200104101106144.png)

插入数据 : insert into user(id,name,sex) values(null,'Dawn','1');

![](../images/deploy/mycat/image-20200104100956216.png)
...
![](../images/deploy/mycat/image-20200104144550132.png)
...
![](../images/deploy/mycat/image-20200104153537319.png)
...
![](../images/deploy/mycat/image-20200104153537320.png)
...
![](../images/deploy/mycat/image-20200104171647471.png)
...
![](../images/deploy/mycat/image-20200202214408231.png)

#### 6.2.5 Keepalived安装配置

![](../images/deploy/mycat/image-20200203010953404.png)
...
![](../images/deploy/mycat/image-20200202193227448.png)
...
![](../images/deploy/mycat/image-20200202220149279.png)

导入Idea

![](../images/deploy/mycat/image-20200202220220682.png)

#### 7.1.2 总体架构

MyCat在逻辑上由几个模块组成: 通信协议、路由解析、结果集处理、数据库连接、监控等模块。如图所示： 

![](../images/deploy/mycat/image-20200107230122662.png)
...
![](../images/deploy/mycat/image-20200107233001248.png)
...
![](../images/deploy/mycat/image-20200108103954458.png)
...
![](../images/deploy/mycat/image-20200108111012502.png)

**MyCat的NIO架构**

如果设置的usingAIO为0 ,那么将走NIOAcceptor通道 , 流程如下: 

![](../images/deploy/mycat/image-20200108111153230.png)
...
![](../images/deploy/mycat/image-20200108112521438.png)


NIOReactor的postRegister方法： 

![](../images/deploy/mycat/image-20200108112959564.png)
...
![](../images/deploy/mycat/image-20200109113445831.png)
...
![](../images/deploy/mycat/image-20200127165109223.png)
...
![](../images/deploy/mycat/image-20200109133647751.png)


通过抓包工具Wireshark抓取到的握手包信息如下, 握手包格式:

![](../images/deploy/mycat/image-20200127162616334.png)
...
![](../images/deploy/mycat/image-20200127163702804.png)
...
![](../images/deploy/mycat/image-20200127163957990.png)


ERROR报文如下 :

![](../images/deploy/mycat/image-20200127165156952.png)
...
![](../images/deploy/mycat/image-20200127170112968.png)

1). 命令包

![](../images/deploy/mycat/image-20200127170235143.png)


2). 结果集包

![](../images/deploy/mycat/image-20200127170823882.png)
...
![](../images/deploy/mycat/image-20200127183259378.png)
...
![](../images/deploy/mycat/image-20200127231628215.png)

客户端发送的认证包转由 FrontendAuthenticator 的Handler来处理, 主要操作就是 拆包, 检查用户名、密码合法性， 检查连接数是够超出限制。源码实现如下： 

![](../images/deploy/mycat/image-20200127232022594.png)

认证失败， 调用failure方法， 认证成功调用success方法。

failure方法源码： 

![](../images/deploy/mycat/image-20200127232344040.png)


success方法源码： 

![](../images/deploy/mycat/image-20200127232422887.png)
...
![](../images/deploy/mycat/image-20200127235140959.png)


处理具体的请求, 返回客户端结果集数据包: 

![](../images/deploy/mycat/image-20200128000050787.png)
...
![](../images/deploy/mycat/image-20200108114506434.png)

父类构造为： 

![](../images/deploy/mycat/image-20200108114611505.png)
...
![](../images/deploy/mycat/image-20200108114952672.png)
...
![](../images/deploy/mycat/image-20200108141645417.png)
...
![](../images/deploy/mycat/image-20200108154627518.png)
...
![](../images/deploy/mycat/image-20200108155642414.png)
...
![](../images/deploy/mycat/image-20200128005840029.png)
...
![](../images/deploy/mycat/image-20200129223657058.png)
...
![](../images/deploy/mycat/image-20200113225535847.png)
...
![](../images/deploy/mycat/image-20200128013501684.png)
...
![](../images/deploy/mycat/image-20200129101108379.png)
...
![](../images/deploy/mycat/image-20200129113055429.png)
